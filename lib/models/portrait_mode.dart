              ...
              children: [
                  ...
                  child: ElevatedButton(
                    ...
                    onPressed: () {
                      if (widget.pomodoroIsPressed) {
                        ...
                        widget.minutes = int.parse(_pomodoroController.text);
                        widget.seconds = 0;
                ...
                ElevatedButton(
                  ...
                  onPressed: () {
                    if (widget.shortBreakIsPressed) {
                      ...
                      widget.minutes = int.parse(_shortBreakController.text);
                      widget.seconds = 0;
                ...
                Container(
                  ...
                  child: ElevatedButton(
                    ...
                    style: ElevatedButton.styleFrom(
                      elevation: widget.longBreakIsPressed == false ? 20 : 0,
                      shadowColor: Colors.black,
                    ...
                    onPressed: () {
                      if (widget.longBreakIsPressed) {
                        ...
                        widget.minutes = int.parse(_longBreakController.text);
                        widget.seconds = 0;
                    ...
                    onPressed: () {
                      if (widget.startIsPressed) {
                        setState(() {
                          ...
                          if ((widget.seconds == 60 || widget.seconds == 00) &&
                              widget.minutes > 0) {
                            widget.seconds = 59;
                            widget.minutes--;
                          }
